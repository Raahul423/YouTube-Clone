...
import menu from './assests/menu_34dp_E8EAED_FILL0_wght400_GRAD0_opsz40.png'
import { faAngleDown, faAngleRight, faBolt, faCartShopping, faCirclePlay, faClapperboard, faClock, faEllipsisVertical, faHouse, faLayerGroup, faLightbulb, faMagnifyingGlass, faMicrophone, faMusic, faNewspaper, faNotesMedical, faPodcast, faSliders, faThumbsUp, faTowerBroadcast, faTrophy, faVestPatches, faVideo } from '@fortawesome/free-solid-svg-icons';
...
import icon4 from './Shorts Images/youtube.png.svg'
import icon5 from './Shorts Images/setting.svg'
import icon6 from './Shorts Images/flag.svg'
import icon7 from './Shorts Images/question mark.svg'
import icon8 from './Shorts Images/feedback.svg'
  ...
  return (
    <section className='App'>
      ...
      {/* just a testing change */}
        ...
        <div className='value'>
          <img src={icon1} className='icon1 ic-1'></img>
          <h1>YouTube Premium</h1>
        </div>

        <div className='value'>
          <img src={icon2} className='icon1 ic-2'></img>
          <h1>YouTube Studio</h1>
        </div>

        <div className='value'>
          <img src={icon3} className='icon1 ic-3'></img>
          <h1>YouTube Music</h1>
        </div>

        <div className='value value'>
          <img src={icon4} className='icon1 ic-3'></img>
          <h1>YouTube Kids</h1>
        </div><hr/>

        <div className='value3 value'>
          <img src={icon5} className='icon1 ic-3'></img>
          <h1>Settings</h1>
        </div>

        <div className='value3 value'>
          <img src={icon6} className='icon1 ic-3'></img>
          <h1>Report history</h1>
        </div>

        <div className='value3 value'>
          <img src={icon7} className='icon1 ic-3'></img>
          <h1>Help</h1>
        </div>

        <div className='value3 value'>
          <img src={icon8} className='icon1 ic-3'></img>
          <h1>Send Feedback</h1>
        </div><hr/>
      ...
      <div className='contant-section'>
        ...
        <div className='Hero-section'>
          ...
          <div className='vedios vid-2'>
            <div className='thumbnail'>
              <img src={thumbnail2} alt='error' style={{ transform: 'none' }}></img>
            </div>
